                ...
                <tbody>
                    <?php foreach ($users as $u): ?>
                        <tr>
                            ...
                            <td>
                                <?php echo htmlspecialchars($u['gym_name'] ?? '—') ?>
                            </td>
                            ...
                            <td><span class="badge <?php echo $u['active'] ? 'badge-work' : 'badge-danger' ?>">
...
<script>
    async function createUser(e) {
        e.preventDefault();
        const data = { name: document.getElementById('u-name').value, email: document.getElementById('u-email').value, password: document.getElementById('u-pass').value, gym_id: +document.getElementById('u-gym').value || null, role: document.getElementById('u-role').value };
