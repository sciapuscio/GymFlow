...
<div class="page-header">
    ...
    <div class="ml-auto flex gap-2">
        <?php if ($activeSession): ?>
            <a href="<?php echo BASE_URL ?>/pages/instructor/live.php?id=<?php echo $activeSession['id'] ?>" class="btn btn-primary btn-sm">
    ...
    <div class="grid grid-2">
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo BASE_URL ?>/pages/instructor/builder.php" class="btn btn-ghost btn-sm">Ver todo</a>
            </div>
            ...
            <?php if (empty($recentSessions)): ?>
                <div class="empty-state" style="padding:30px">
                    ...
                    <a href="<?php echo BASE_URL ?>/pages/instructor/builder.php" class="btn btn-primary btn-sm">Crear Sesión</a>
                </div>
            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif ($s['status'] === 'playing'): ?>
                                            <a href="<?php echo BASE_URL ?>/pages/instructor/live.php?id=<?php echo $s['id'] ?>" class="btn btn-sm"
                                                style="background:rgba(0,245,212,0.2);color:var(--gf-accent)">🔴 Control</a>
                                        <?php else: ?>
